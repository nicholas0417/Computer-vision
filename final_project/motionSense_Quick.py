...
# toGrey It converts an RGB array to a grey scale with n amounts of colors available. 
def toGrey(color, n):
...
def main():
    ...
    while 1:
        ...
        #initializing a matrix that will contain the difference between two frames (later will be the difference between average frames and new frame.)
